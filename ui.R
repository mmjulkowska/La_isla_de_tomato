...
tabPanel("Clustering Heat Map",
      ...
      helpText("The below graph represents a dendrogram of the accessions and how they are clustered based on the selected traits. The accessions are clustered using Ward linkage method and the x-axis is represents the distance between the individual accessions."),
